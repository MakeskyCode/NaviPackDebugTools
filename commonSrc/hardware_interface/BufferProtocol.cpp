...
int BufferProtocol::PushBuffer(const uint8_t * points, int32_t len)
{
...
const uint8_t * BufferProtocol::PackageBuffer(const uint8_t * points, int32_t in_len, int32_t * out_len)
{
	*out_len = in_len;
	return points;
}
